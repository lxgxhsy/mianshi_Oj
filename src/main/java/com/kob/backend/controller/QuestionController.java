...
import com.kob.backend.manager.CounterManager;
import com.kob.backend.model.dto.question.QuestionAddRequest;
import com.kob.backend.model.dto.question.QuestionEditRequest;
import com.kob.backend.model.dto.question.QuestionQueryRequest;
import com.kob.backend.model.dto.question.QuestionUpdateRequest;
   ...
   @SaCheckRole(UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<Page<QuestionVO>> listQuestionVOByPageSentinel(@RequestBody QuestionQueryRequest questionQueryRequest,
        ...
        try{
            ...
            // 限流操作
            return ResultUtils.error(ErrorCode.SYSTEM_ERROR, "访问过于频繁，请耐心等待");
        }finally {
            if(entry != null){
