package com.kob.backend.sentinel;
...
public class SentinelRulesManager {
	...
	public void initRules() throws Exception{
		log.info("{}","sentinel rules init");
		initFlowRules();
		initDegradeRules();
		listenRules();
		log.info("{}","sentinel rules stop");
	}
	...
	public void initDegradeRules() {
		...
		DegradeRule slowCallRule = new DegradeRule("listQuestionVOByPage")
				.setGrade(CircuitBreakerStrategy.SLOW_REQUEST_RATIO.getType()) //满请求比例
		...
		DegradeRule errorRateRule = new DegradeRule("listQuestionVOByPage") //异常的降级规则
	...
	public void listenRules() throws Exception {
		...
		System.out.println("dsd" + rootPath);
		// sentinel 目录路径
